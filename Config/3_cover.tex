...
\nttitle(main,en){Restructuring and extending\\the KLx employee and application management system}%
...
%-------------------------------------------------------------------
\ntauthorname(m){Thiago Araujo Monteiro}{Thiago Monteiro}
...
%                           [m] for male
%         You may use "\\" to force line breaks
\ntaddperson{adviser}(c,f){Carla Ferreira, Full Professor, NOVA University Lisbon}
\ntaddperson{adviser}(a,f){Magda Rafaela Teixeira de Encarnação, Team Leader, KLx}
%\ntaddperson{adviser}(c,f){Teresa Romão, Associate Professor, NOVA University Lisbon}
